...
export const SyncAuthUserResponse = zod.object({
  ...
  "role": zod.enum(['VISITOR', 'STUDENT', 'TEACHER', 'ACADEMIC_SERVICE', 'FINANCIAL_SERVICE', 'ADMIN', 'DIRECTOR']),
...
export const HandleClerkWebhookBody = zod.object({
  "type": zod.string().describe('Clerk event type (e.g. user.created, user.updated)'),
  "data": zod.object({

}).passthrough().describe('Clerk event payload')
})

export const HandleClerkWebhookResponse = zod.unknown()
...
export const UpdateUserBody = zod.object({
  "role": zod.enum(['VISITOR', 'STUDENT', 'TEACHER', 'ACADEMIC_SERVICE', 'FINANCIAL_SERVICE', 'ADMIN', 'DIRECTOR']).optional(),
...
export const CreateFiliereResponse = zod.object({
  "id": zod.string(),
  "name": zod.string(),
  "code": zod.string(),
  "description": zod.string().nullish(),
...
export const DeleteFiliereResponse = zod.void()
...
export const GetTeacherByIdResponse = zod.object({
  "id": zod.string(),
  "userId": zod.string(),
  "code": zod.string(),
  "firstName": zod.string(),
...
export const ListInscriptionsResponse = zod.object({
  "inscriptions": zod.array(zod.object({
  "id": zod.string(),
...
export const CreateInscriptionResponse = zod.object({
  "id": zod.string(),
  "studentId": zod.string(),
  "student": zod.object({
  "id": zod.string(),
...
export const GetEnrollmentByIdResponse = zod.object({
  "id": zod.string(),
  "studentId": zod.string(),
  "courseId": zod.string(),
  "course": zod.object({
...
export const ListPaymentsQueryParams = zod.object({
  ...
  "status": zod.enum(['INITIATED', 'PENDING', 'CONFIRMED', 'FAILED', 'CANCELLED']).optional(),
...
export const ListPaymentsResponse = zod.object({
  ...
  "operator": zod.enum(['VODACOM_MONEY', 'AIRTEL_MONEY', 'ORANGE_MONEY']),
  "phoneNumber": zod.string(),
  "status": zod.enum(['INITIATED', 'PENDING', 'CONFIRMED', 'FAILED', 'CANCELLED']),
...
export const PaymentCallbackResponse = zod.unknown()
...
export const GetEvaluationByIdResponse = zod.object({
  "id": zod.string(),
  "courseId": zod.string(),
  "title": zod.string(),
  "type": zod.enum(['QCM', 'TRUE_FALSE', 'SHORT_ANSWER', 'ESSAY', 'MIXED']),
...
export const ListEvaluationResultsResponse = zod.array(ListEvaluationResultsResponseItem)
...
export const GetTeacherAnalyticsResponse = zod.object({
  ...
  "averageScore": zod.number().nullish(),
  "courseEngagement": zod.array(zod.object({
  "courseId": zod.string(),
  "courseTitle": zod.string(),
...
export const GetAcademicAnalyticsResponse = zod.object({
  ...
  "enrollmentsByFiliere": zod.array(zod.object({
  "filiereId": zod.string(),
  "filiereName": zod.string(),
  "studentCount": zod.number()
})),
  "weeklyRegistrations": zod.array(zod.object({
  "week": zod.string(),
  "count": zod.number()
}))
})
...
export const GetFinancialAnalyticsResponse = zod.object({
  ...
  "revenueByOperator": zod.array(zod.object({
  "operator": zod.string(),
  "amount": zod.string(),
  ...
  "revenueTimeline": zod.array(zod.object({
  "date": zod.string(),
  "amount": zod.string(),
  "count": zod.number()
}))
