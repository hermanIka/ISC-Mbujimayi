...
export type InscriptionDocumentType = typeof InscriptionDocumentType[keyof typeof InscriptionDocumentType];
...
export type UpdateInscriptionStatusBodyStatus = typeof UpdateInscriptionStatusBodyStatus[keyof typeof UpdateInscriptionStatusBodyStatus];
...
export type UpdateCourseBodyStatus = typeof UpdateCourseBodyStatus[keyof typeof UpdateCourseBodyStatus];
...
export type CreateChapterBodyType = typeof CreateChapterBodyType[keyof typeof CreateChapterBodyType];
...
export type UpdateChapterBodyType = typeof UpdateChapterBodyType[keyof typeof UpdateChapterBodyType];
...
export type PaymentOperator = typeof PaymentOperator[keyof typeof PaymentOperator];


export const PaymentOperator = {
  VODACOM_MONEY: "VODACOM_MONEY",
...
export type InitiatePaymentBodyType = typeof InitiatePaymentBodyType[keyof typeof InitiatePaymentBodyType];
...
export type InitiatePaymentBodyOperator = typeof InitiatePaymentBodyOperator[keyof typeof InitiatePaymentBodyOperator];
...
export type CreateEvaluationBodyType = typeof CreateEvaluationBodyType[keyof typeof CreateEvaluationBodyType];
...
export type ListInscriptionsStatus = typeof ListInscriptionsStatus[keyof typeof ListInscriptionsStatus];
