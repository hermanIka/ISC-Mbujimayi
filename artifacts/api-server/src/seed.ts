...
async function seed() {
  ...
  const paymentData: InsertPayment[] = [
    ...
    { id: nanoid(), studentId: students[1].id, reference: "ISC-003-IJKL", amount: "75000", currency: "CDF", type: "INSCRIPTION_FEE", operator: "MTN_MONEY", phoneNumber: "+243823456789", status: "INITIATED", operatorRef: null },
